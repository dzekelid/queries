...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/payrun/apis.md
...
- name: Pay Run.IO - Get the query result
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/payrun/query-post-openapi.md
- name: Pay Run.IO - Get the query result
  x-api-slug: query-post
  description: Get the results for the specified query
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28484-payrun-io.jpg
