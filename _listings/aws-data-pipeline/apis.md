...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/aws-data-pipeline/apis.md
...
- name: AWS Data Pipeline API - Query Objects
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/aws-data-pipeline/actionqueryobjects-get-openapi.md
- name: AWS Data Pipeline API - Query Objects
  x-api-slug: actionqueryobjects-get
  description: Queries the specified pipeline for the names of objects that match
    the specified set of conditions.
