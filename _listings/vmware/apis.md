...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/vmware/apis.md
...
- name: vRealize Operations 6 - Query Alerts
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/vmware/apialertsquery-post-openapi.md
- name: vRealize Operations 6 - Get Resources
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/vmware/apiresourcesquery-post-openapi.md
- name: vRealize Operations 6 - Query Symptoms
  x-api-slug: apisymptomsquery-post
  description: 'TODO: Add Description'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/VMware_logo.png
  humanURL: http://vmware.com
  baseURL: https://example.com//suite-api/api
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/vmware/apisymptomsquery-post-openapi.md
- name: vRealize Operations 6 - Query Alerts
  x-api-slug: apialertsquery-post
  description: 'TODO: Add Description'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/VMware_logo.png
