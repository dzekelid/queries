...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/shopify/apis.md
...
- name: Shopify API - Get all gift cards that matches the query
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/shopify/admingift-cardssearch-json-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/queries/master/_listings/shopify/admingift-cardssearch-json-get-openapi.md
- name: Shopify API - Get all gift cards that matches the query
  x-api-slug: admingift-cardssearch-json-get
  description: Get all gift cards that matches the query.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Shopify-logo.png
